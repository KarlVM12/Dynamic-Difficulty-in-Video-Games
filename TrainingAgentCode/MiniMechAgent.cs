...
public class MiniMechAgent : Agent, EnemyInterface
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        Debug.Log("MiniMech Health: " + health);
        Debug.Log("MiniMech Hit Counter: " + hitCounter);
        ...
        // move player's & minimech's transform to beginning
        ...
        Debug.Log("MiniMech Health: " + health);
        Debug.Log("MiniMech Hit Counter: " + hitCounter);
        Debug.Log("MiniMech Awareness: " + awareness);
    }
