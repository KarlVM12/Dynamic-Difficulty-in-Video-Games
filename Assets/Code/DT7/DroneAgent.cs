...
public class DroneAgent : Agent, EnemyInterface
{
    ...
    private void Awake()
    {
        ...
        // works when world is not rotated, just have to wait till after rotation to setActive
        maxLeft = transform.position.x - 6f;
        maxRight = transform.position.x + 6f;

        // Don't have to use this as long as enemies around active until after the world is rotated
        //maxLeft = transform.position.z - 6f + 52.75f; // since alex rotates level one by 90 degree around y-axis and pushes all x-values forward 52.75f, rotation around y 90 degress causing movement to switch from x-axis to z-axis
        //maxRight = transform.position.z + 6f + 52.75f;
        ...
        //Debug.Log("Drone: " + spawn + " Limits: " + maxLeft + ", " + maxRight);
    ...
    public void Update()
    {
        ...
        //Debug.Log(transform.position + " Drone: " + spawn + " Limits: " + maxLeft + ", " + maxRight);
    }
